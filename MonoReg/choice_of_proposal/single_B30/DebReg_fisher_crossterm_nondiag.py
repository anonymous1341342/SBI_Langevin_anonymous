...
def main(task_id):
    ...
    print(f"Training data size for Deb Reg: {theta_r0_extra.shape[0]}, Validation data size for Deb Reg: {val_theta_r0_extra.shape[0]}")
    ...
    os.makedirs('DebRegModel_fisher_crossterm_nondiag', exist_ok=True)

    torch.save(DebReg_model, f'DebRegModel_fisher_crossterm_nondiag/model_task{task_id}.pth')
